 ...
 */
export const ProductsDetail = ({ productId, onBack }: ProductsDetailProps) => {
  const { user } = useAuth()
    ...
    <>
      <div className="space-y-6">
        ...
        {product.type === 'set' && (
          <Card className="p-4">
            <div className="mb-4">
              <h3 className="text-lg font-semibold">Composición del Set</h3>
            </div>
            ...
            <div className="mt-4 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
              <p className="text-sm text-yellow-800">
                ...
                endpoints de backend pendientes de implementación (POST, DELETE,
                PATCH /products/:id/components).
              </p>
            </div>
          </Card>
        )}
